...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE prevInstance, LPSTR iCmdLine, int iCmdShow)
{
	...
	MSG msg;
	HWND hwnd;
	TCHAR szAppName[] = TEXT("SquareAnimation5");
		...
		case WM_PAINT:
			...
			switch(flag){
				...
				case 2:
					...
					rectTemp.bottom = rect.bottom - (iPaintFlag * rect.bottom/100);
					rectTemp.left = rect.left;
					rectTemp.right = rect.right - (iPaintFlag * rect.right/100);
					break;
				...
				case 3:
					rectTemp.top = rect.top;
					rectTemp.bottom = rect.top + (iPaintFlag * rect.bottom/100);
					rectTemp.left = rect.left;
					rectTemp.right = rect.left + (iPaintFlag * rect.right/100);
					break;
				...
				case 4:
					rectTemp.top = rect.top;
					rectTemp.bottom = rect.bottom - (iPaintFlag * rect.bottom/100);
					rectTemp.left = rect.left + (iPaintFlag * rect.right/100);
				...
				case 5:
					rectTemp.top = rect.top;
					rectTemp.bottom = rect.top + (iPaintFlag * rect.bottom/100);
					rectTemp.left = rect.right - (iPaintFlag * rect.right/100);
					rectTemp.right = rect.right;
					break;
